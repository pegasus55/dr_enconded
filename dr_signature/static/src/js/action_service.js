...
function makeCustomActionManager(env) {
    ...
    async function _triggerDownload(action, options, type) {
        ...
        let signature = action.context.signature
...
export const customActionService = {
    ...
    start(env) {
        return makeCustomActionManager(env);
    },
};

registry.category("services").remove("action");
registry.category("services").add("action", customActionService);