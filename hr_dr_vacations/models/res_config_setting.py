...
class VacationsSettings(models.TransientModel):
    ...
    planning_notifications = fields.Selection(_NOTIFICATIONS, string='Planning notifications mode', required=True)
    planning_administrator_id = fields.Many2one('hr.employee', string='Planning administrator')
    planning_second_administrator = fields.Many2one('hr.employee', string='Second planning administrator')
    execution_notifications = fields.Selection(_NOTIFICATIONS, string='Execution notifications mode', required=True)
    execution_administrator_id = fields.Many2one('hr.employee', string='Execution administrator')
    execution_second_administrator = fields.Many2one('hr.employee', string='Second execution administrator')
    vacation_lost_automatic_discount = fields.Boolean(string='Vacation lost automatic discount', default=False)
    _SM = [
