...
class TestAttendanceDeviceMock(SavepointCase):
    ...
    def test_04_action_clear_data(self):
        with self.assertRaises(ValidationError, msg = "test_action_clear_data failed"):
            self.attendance_device.action_clear_data()

    # 12. Download user
    def test_05_action_user_download(self):
        self.attendance_device.action_user_download()
        self.assertEqual(self.attendance_device.device_users_count, 1, "test_action_user_download failed")

    # 12. Upload users
    def test_06_action_user_upload(self):
        self.attendance_device.action_user_upload()
        self.assertEqual(len(ZkDeviceMock.users), 3, "test_action_user_upload failed")
    ...
    def test_10_action_employee_upload_to_device(self):
        ...
        self.assertEqual(self.attendance_device.device_users_count, 4, "test_action_employee_upload passed failed")
   ...
   # Form test
    ...
    def test_23_attendance_device_generate_employee(self):
        ...
        # when Generate Emloyees is enabled, action_employee_map() will create an employee named "test"
        self.attendance_device.create_employee_during_mapping = True
        self.attendance_device.action_employee_map()
