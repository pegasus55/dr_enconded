# -*- coding: utf-8 -*-
{
    'name': "Permissions (EC Private)",

    'summary': """
        Module to manage the permissions, licenses and service commissions of the collaborators.""",

    'description': """
        Module to manage the permissions, licenses and service commissions of the collaborators. It incorporates the information for the private sector of Ecuador.
    """,
