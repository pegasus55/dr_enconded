...
class UpdateDepartmentEmployee(models.TransientModel):
    _name = 'hr.update.department.employee'
    _description = 'Update department employee'
    ...
    def action_accept(self):
        if self.actual_department_id != self.department_id:
            ...
            if edh:
                edh.department_id = self.department_id
            self.employee_id.department_id = self.department_id
        else:
            # El departamento destino debe ser diferente al departamento actual.
