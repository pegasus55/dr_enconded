...
class Contract(models.Model):
    ...
    @api.constrains('normative_acronym',
                    'mode',
                    'wage',
                    'last_minimum_salary')
    def _constrain_wage(self):
        if self.normative_acronym == 'CODIGOT':
    ...
    IESS_sector_code = fields.Many2one('hr.sector.table', string='IESS sector code', tracking=True,
