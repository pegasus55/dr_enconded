# -*- coding: utf-8 -*-
{
    'name': "Management (EC Private)",

    'summary': """
        Module to manage the general configurations of human talent.""",

    'description': """
        Module to manage the general configurations of human talent. It incorporates the information for the private sector of Ecuador.
    """,
