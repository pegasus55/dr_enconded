...
_REGIONS = [
    ...
    ('sierra-eastern', 'Sierra - Oriente'),
    ('coast-island', 'Costa - Galápagos')
]
...
class HrAssetsLiquidation(models.Model):
    ...
    region = fields.Selection(_REGIONS, string='Region', required=True, tracking=True)
    ...
    date_from = fields.Date(string='Contract date end', required=True, default=date.today().replace(day=1))
    date_to = fields.Date(string='Contract date end', required=True, default=date.today())
        ...
        if self.employee_id.id:
            ...
            if self.employee_id.contract_id.payment_period_fourteenth:
                if self.employee_id.contract_id.payment_period_fourteenth == 'sierra_oriente_fourteenth_salary':
                    self.region = 'sierra-eastern'
                if self.employee_id.contract_id.payment_period_fourteenth == 'costa_fourteenth_salary':
                    self.region = 'coast-island'
            self.disability = self.employee_id.disability
    ...
    def _get_fourteenth(self):
        ...
        period_start_month = {'coast-island': 3, 'sierra-eastern': 8}
