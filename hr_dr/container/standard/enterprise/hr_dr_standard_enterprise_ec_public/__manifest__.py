# -*- coding: utf-8 -*-
{
    'name': "Human talent standard enterprise (EC Public)",

    'summary': """
        Standard version of the enterprise human talent system for the public sector of Ecuador.""",
    ...
    'depends':
        [
            ...
            'hr_dr_contract_ec_public_data',

            'hr_dr_payroll_base',
            'hr_dr_payroll_enterprise',
            'hr_dr_payroll_enterprise_ec_public',
        ],
